...
type CloudflarePagesLogoProps = {
    width: number,
    displayText?: boolean
}

const CloudflarePagesLogo: React.FC<CloudflarePagesLogoProps> = ({
    width,
    displayText = false
}) => {
    ...
    if (displayText) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 174 68" width={width}>
...
export default CloudflarePagesLogo
